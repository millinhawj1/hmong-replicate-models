...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        expression_scale: float = Input(
            description="Expression intensity — lower = smoother, more natural (0.1–2.0)",
        ...
        spec = VOICES[voice]
        work_dir = SysPath(tempfile.mkdtemp(prefix="hmong_sing_"))
        ...
        # ── Step 2: SadTalker (singing-photo quality settings) ─────────────
